...
export const ApiGetPostsDocs = () => {
  return applyDecorators(
    ...
    ApiQuery({ name: 'brandId', required: false, description: '', example: '' }),
    ApiQuery({ name: 'modelId', required: false, description: '', example: '' }),
    ApiQuery({ name: 'versionId', required: false, description: '', example: '' }),
    ApiQuery({
      name: 'typeOfVehicle',
      required: false,
      description: '',
